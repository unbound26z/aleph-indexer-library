 ...
 * @property [_writable_] escrowedWantedTokenAccount
 * @property [_writable_] maker
 * @property [_writable_] escrowedOfferedTokens
 * @property [] offeredTokensMint
...
export type ExecuteTransactionInstructionAccounts = {
  ...
  escrowedWantedTokenAccount: web3.PublicKey
  maker: web3.PublicKey
  escrowedOfferedTokens: web3.PublicKey
  offeredTokensMint: web3.PublicKey
...
export function createExecuteTransactionInstruction(
  ...
  const keys: web3.AccountMeta[] = [
    ...
    {
      pubkey: accounts.escrowedWantedTokenAccount,
      isWritable: true,
      isSigner: false,
    },
    {
    ...
    {
      pubkey: accounts.offeredTokensMint,
      isWritable: false,
      isSigner: false,
    },
    {
